...
console.log(7896789657952673548762534523427634578235462538472534523645);
console.log(7896789657952673548762534523427634578235462538472534523645n);
console.log(BigInt(7896789657952673548762534523427634578235462538472534523645));
console.log(BigInt(7898965795235));

// Operations
console.log(1000n + 1000n);
console.log(
  7896789657952673548762534523427634578235462538472534523645n * 10000000n
);
// console.log(Math.sqrt(16n)); // Cannot convert a BigInt value to a number

const huge = 2345234324534552342342n;
const num = 23;
...
console.log(new Date('Aug 02 2020 16:05:41'));
...
//   account.movementsDates.forEach((date, index) => {
...
const pizzaTimer = setTimeout(
  (ing1, ing2) => console.log(`here is your pizza🍕 with ${ing1} nad ${ing2}`),
  2000,
  ...ingredients
);
console.log('Waiting...');
