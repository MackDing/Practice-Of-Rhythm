...
class LaserWeaponArmory(Scene):
    def enter(self):
        ...
        code = f"{randint(1, 9)}{randint(1, 9)}{randint(1, 9)}"  # 返回三个 1 到 9 之间的数字
        guess = input("[keypad]> ")
        guesses = 0
        print(code)
...
class TheBridge(Scene):
    def enter(self):
        print(dedent("""
        You burst onto the Bridge with the netreon destruct bomb under your arm and surprise 5 Gothons who aree trying to take control of the ship.
        Each of them has an even uglier clown constume than the last.
        ...
        if action == "throw the bomb":
            ...
            Right as you deop it a Gothon shoots you right in the back killing you.
